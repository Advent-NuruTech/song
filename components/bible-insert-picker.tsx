...
export function BibleInsertPicker({ visible, onClose, onInsert }: {
  ...
  return <Modal visible={visible} transparent={Platform.OS === "web"} animationType={Platform.OS === "web" ? "fade" : "slide"} presentationStyle={Platform.OS === "web" ? "overFullScreen" : "pageSheet"} onRequestClose={onClose}>
    <View style={[Platform.OS === "web" ? styles.desktopBackdrop : styles.nativeBackdrop, Platform.OS === "web" && compactLayout && styles.compactBackdrop]}>
    <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={[styles.container, Platform.OS === "web" && styles.desktopDialog, Platform.OS === "web" && compactLayout && styles.compactDialog, Platform.OS === "web" && dialogMaximized && styles.desktopDialogMaximized, { backgroundColor: colors.background, borderColor: colors.border }]}>
...
const styles = StyleSheet.create({
  nativeBackdrop: { flex: 1 }, desktopBackdrop: { flex: 1, padding: 22, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(2,6,23,.68)" }, compactBackdrop: { padding: 0, justifyContent: "flex-end" }, container: { flex: 1, minHeight: 0 }, desktopDialog: { width: "100%", maxWidth: 1040, height: "90%", flex: 0, borderWidth: 1, borderRadius: 20, overflow: "hidden", shadowColor: "#000", shadowOffset: { width: 0, height: 18 }, shadowOpacity: .28, shadowRadius: 36 }, compactDialog: { height: "100%", maxWidth: "100%", borderWidth: 0, borderRadius: 0 }, desktopDialogMaximized: { width: "100%", maxWidth: "100%", height: "100%", borderRadius: 0 }, header: { flexShrink: 0, minHeight: 64, borderBottomWidth: 1, paddingHorizontal: 14, flexDirection: "row", alignItems: "center" }, headerCopy: { flex: 1, minWidth: 0 }, title: { fontSize: 20, fontWeight: "900" }, subtitle: { fontSize: 11, marginTop: 3 }, iconButton: { width: 42, height: 42, alignItems: "center", justifyContent: "center" }, center: { flex: 1, padding: 28, alignItems: "center", justifyContent: "center", gap: 12 },
  ...
  chapterArea: { flex: 1, minHeight: 0 }, chapterHeader: { flexShrink: 0, minHeight: 40, paddingHorizontal: 14, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, backButton: { flexDirection: "row", alignItems: "center" }, backText: { fontWeight: "900" }, selectAll: { fontSize: 12, fontWeight: "900" }, chapterRow: { paddingHorizontal: 14, paddingVertical: 7, gap: 7 }, chapterChip: { width: 36, height: 36, borderWidth: 1, borderRadius: 18, alignItems: "center", justifyContent: "center" }, chapterText: { fontSize: 12, fontWeight: "800" }, verseList: { paddingHorizontal: 14, paddingBottom: 14 }, verseRow: { flexDirection: "row", gap: 10, padding: 10, marginBottom: 3, borderWidth: 1, borderRadius: 11 }, verseNumber: { width: 22, fontSize: 12, fontWeight: "900", paddingTop: 2 }, verseText: { flex: 1, fontSize: 15, lineHeight: 22 },
  previewPanel: { flexShrink: 0, maxHeight: "42%", margin: 10, marginTop: 0, borderWidth: 1, borderRadius: 16, padding: 12, shadowColor: "#000", shadowOffset: { width: 0, height: 4 }, shadowOpacity: .14, shadowRadius: 10, elevation: 8 }, previewPanelExpanded: { maxHeight: "56%" }, previewHeader: { flexShrink: 0, flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 8 }, previewCopy: { flex: 1, minWidth: 0 }, previewTitle: { fontSize: 14, fontWeight: "900" }, previewHelp: { fontSize: 10, marginTop: 2 }, previewRef: { fontSize: 11, fontWeight: "900" }, previewSizeButton: { width: 34, height: 34, alignItems: "center", justifyContent: "center", borderRadius: 9 }, previewInput: { flexShrink: 1, minHeight: 62, borderWidth: 1, borderRadius: 11, padding: 10, fontSize: 14, lineHeight: 20, textAlignVertical: "top" }, insertButton: { flexShrink: 0, minHeight: 46, marginTop: 9, borderRadius: 12, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 },
});
